...
def define_G():
    ...
    ngf = cfg.ngf
    netG = cfg.netG
    n_down_sample_global = cfg.n_down_sample_global
    n_blocks_global = cfg.n_blocks_global
    n_blocks_local = cfg.n_blocks_local
    n_local_enhancers = 1
    norm = cfg.norm
    gpu_ids = cfg.gpu_ids
    ...
    if netG == 'local':
        netG = LocalEnhancer(input_nc, output_nc, ngf,
                             n_down_sample_global,
                             n_blocks_global, n_local_enhancers, n_blocks_local,
                             norm_layer)
    else:
...
class LocalEnhancer(nn.Module):
    def __init__(self, input_nc, output_nc, ngf=32, n_downsample_global=3, n_blocks_global=9,
        ...
        for n in range(1, n_local_enhancers + 1):
            ...
            #
            # model_downsample = [nn.ReflectionPad2d(6),
            #                     nn.Conv2d(input_nc, ngf_global, kernel_size=7, padding=0, dilation=2),
            #                     norm_layer(ngf_global),
            #                     nn.ReLU(True),
            #                     nn.ReflectionPad2d(3),
            #                     nn.Conv2d(ngf_global, ngf_global, kernel_size=7, padding=0),
            #                     norm_layer(ngf_global),
            #                     nn.ReLU(True),
            #                     nn.Conv2d(ngf_global, ngf_global * 2, kernel_size=3, stride=2, padding=1),
            #                     norm_layer(ngf_global * 2), nn.ReLU(True)]
